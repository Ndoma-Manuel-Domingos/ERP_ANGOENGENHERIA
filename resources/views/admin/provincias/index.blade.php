                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('provincias.create') }}" class="btn btn-sm btn-primary">Novo Província</a>
                            </h3>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    <a class="dropdown-item" href="{{ route('provincias.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                                                    <a class="dropdown-item" href="{{ route('provincias.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
