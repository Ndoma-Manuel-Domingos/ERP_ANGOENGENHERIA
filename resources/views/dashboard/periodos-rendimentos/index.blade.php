                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <a href="{{ route('periodos-rendimentos.create') }}" class="btn btn-sm btn-primary">Novo Período de Rendimento</a>
                                @endif
                            </h3>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('periodos-rendimentos.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                                                    @endif
                                                    @if (Auth::user()->can('editar periodo'))
                                                    <a class="dropdown-item" href="{{ route('periodos-rendimentos.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
                                                    @endif
