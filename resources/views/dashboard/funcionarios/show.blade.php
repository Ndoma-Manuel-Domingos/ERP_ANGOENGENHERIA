    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Detalhe Funcionário</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                                    ...
                                    <div class="col-12 col-md-4">
                                        <table class="table text-nowrap">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Salário Base</th>
                                                    <td class="text-right"> {{ number_format($contrato->pacote_salarial->salario_base ?? 0, 2, ',', '.' ) ?? '-------------' }} AOA</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="col-12 col-md-4">
                                        <table class="table text-nowrap">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-left">{{ number_format($contrato->subsidio_natal ?? 0, 1, ',', '.' ) }} % => {{ number_format(($contrato->pacote_salarial->salario_base * ($contrato->subsidio_natal / 100)) ?? 0, 2, ',', '.' ) ?? '-------------' }} AOA</td>
                                                    <td class="text-left">{{ number_format($contrato->subsidio_ferias ?? 0, 1, ',', '.' ) }} % => {{ number_format(($contrato->pacote_salarial->salario_base * ($contrato->subsidio_ferias / 100)) ?? 0, 2, ',', '.' ) ?? '-------------' }} AOA</td>
                                                </tr>
