                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-footer clearfix d-flex">
                            <a href="{{ route('turmas.edit', $turma->id) }}" class="btn btn-sm btn-success mx-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('turmas.destroy', $turma->id ) }}" method="post">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-sm btn-danger mx-1" onclick="return confirm('Tens Certeza que Desejas excluir esta turma?')">
                  ...
                  <div class="card">
                      <div class="card-header">
                        <h5>
                          Lista de Alunos
                          @if (count($pautas) > 0)
                          <a href="{{ route('turma-visualizar-pautas', $turma->id) }}" class="btn btn-sm btn-info float-right mx-1">Visualizar Pauta</a>
                          @endif
                        ...
                        <table class="table table-hover text-nowrap">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><a href="{{ route('alunos.show', $aluno->aluno->id) }}">{{ $aluno->aluno->nome }} </a></td>
                              ...
                              <td class="d-flex">
                                <a href="{{ route('alunos.show', $aluno->aluno->id) }}" class="btn btn-sm btn-info mx-1">
                                  <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('alunos.edit', $aluno->aluno->id) }}" class="btn btn-sm btn-success mx-1">
                                  <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('alunos.destroy', $aluno->aluno->id ) }}" method="post">
                                  ...
                                  <button type="submit" class="btn btn-sm btn-danger mx-1"
                                    onclick="return confirm('Tens Certeza que Desejas excluir esta alunos?')">
                                    <i class="fas fa-trash"></i>
                                  </button>
                                </form>
                              </td>
                        ...
                        <table class="table table-hover text-nowrap">
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="d-flex">
                                <a href="{{ route('formadores.show', $item->formador->id) }}" class="btn btn-sm btn-info mx-1">
                                  <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('formadores.edit', $item->formador->id) }}" class="btn btn-sm btn-success mx-1">
                                  <i class="fas fa-edit"></i>
                                </a>
