                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <a href="{{ route('produtos-compras.create') }}" class="btn btn-sm btn-primary">Novo Produto</a>
                                @endif
                            </h3>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('produtos-compras.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                                                    @endif
                                                    @if (Auth::user()->can('editar produtos'))
                                                    <a class="dropdown-item" href="{{ route('produtos-compras.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
                                                    @endif
                                                    <div class="dropdown-divider"></div>
                                                    @if (Auth::user()->can('eliminar produtos'))
                                                    <form action="{{ route('produtos-compras.destroy', $item->id ) }}" method="post">
                                                        @csrf
                                                        @method('DELETE')
