                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                @if (Auth::user()->can('criar rendimento'))
                                <a href="{{ route('tipos-rendimentos.create') }}" class="btn btn-sm btn-primary">Novo Tipo de Rendimento</a>
                                @endif
                            </h3>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('tipos-rendimentos.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                                                    @endif
                                                    @if (Auth::user()->can('editar rendimento'))
                                                    <a class="dropdown-item" href="{{ route('tipos-rendimentos.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
                                                    @endif
