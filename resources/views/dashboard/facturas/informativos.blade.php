          ...
          <div class="card">
            <div class="card-header">
              ...
              @if (isset($_GET['factura']))
                <a href="{{ route('pdf-facturas-informativo', $_GET['factura']) }}" target="_blink" class="btn btn-sm btn-info float-right"><i class="fas fa-file-pdf"></i> Exportar PDF</a>
              @else
                <a href="{{ route('pdf-facturas-informativo') }}" target="_blink" class="btn btn-sm btn-info float-right"><i class="fas fa-file-pdf"></i> Exportar PDF</a>
              @endif
            </div>
            <!-- /.card-header -->
            <div class="card-body">
