...
<head>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td  style="border-left: #eaeaea 1px solid; padding: 2px">
                        <strong>NIF: {{ $factura->cliente->nif }}</strong>
                    </td>
                </tr>
        ...
        <footer style="position: absolute;bottom: 30;right: 30px;left: 30px;">
            ...
            <table style="border-top: 2px solid #000000">
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: left;padding: 3px 0;">CONTA: {{ $loja->empresa->conta1 }}</td>
                        <td></td>
                    </tr>
    
                    <tr>
                        <td style="text-align: left;padding: 3px 0;">IBAN: {{ $loja->empresa->iban1 }}</td>
                        <td></td>
                    </tr>
                    
                    <tr>
                        <td colspan="2" style="padding: 3px 0;margin-top: 30px;display: block;font-style: italic">Os bens/serviços foram colocados à disposição do adquirente na data do documento</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 3px 0; text-align: center;border-top: 2px solid #000000">Software de facturação, desenvolvido pela {{ env('APP_NAME') }} </td>
                    </tr>
    ...
    <header style="position: absolute;top: 30;right: 30px;left: 30px;width: 250px">
        <table>
            ...
            <tr>
                <td style="padding: 5px 0;text-transform: uppercase">
                    <strong style="text-transform: uppercase">{{ $loja->empresa->nome }}</strong>
                </td>
            </tr>
            <tr>
                <td>
                    <strong style="text-transform: uppercase">Endereço:</strong> <span style="text-transform: uppercase">{{ $loja->empresa->morada }}</span>
                </td>
                <td>DADOS CLIENTES</td>
            </tr>
            <tr>
                <td>
                    <strong style="text-transform: uppercase">NIF:</strong> <span style="text-transform: uppercase">{{ $loja->empresa->nif }}</span>
                </td>
                <td  style="border-top: #eaeaea 1px solid;border-left: #eaeaea 1px solid; padding: 2px;">
            ...
            <tr>
                ...
                <td  style="border-left: #eaeaea 1px solid; padding: 2px">
                    <strong style="text-transform: uppercase">NIF: {{ $factura->cliente->nif }}</strong>
                </td>
            </tr>
    ...
    <main style="position: absolute;top: 230px;right: 30px;left: 30px;width: 250px;">
        <table>
            ...
            <tr>
                <td style="text-transform: uppercase;padding: 10px 0;font-size: 11px;font-weight: bolder">Luanda-Angola <br><br> FACTURA</td>
            </tr>

            <tr>
                @if ($factura->convertido_factura == "Y")
                    <td style="text-transform: uppercase;font-weight: bolder;font-size: 13px">{{ $factura->factura_next }} conforme {{ $factura->numeracao_proforma }}</td>
                @else
        ...
        <table style="border-top: 2px solid #000000">
            <tbody>
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">COORDENADAS BANCÁRIAS</td>
                ...
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">BANCO: {{ $loja->empresa->banco }}</td>
                ...
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">CONTA: {{ $loja->empresa->conta }}</td>
                ...
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">IBAN: {{ $loja->empresa->iban }}</td>
                ...
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">BANCO: {{ $loja->empresa->banco1 }}</td>
                    <td style="padding: 3px 0;margin-top: 30px;display: block;color: red">Retenção: {{ number_format($total_retencao , '2', ',', '.')}}</td>
                </tr>
           
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">CONTA: {{ $loja->empresa->conta1 }}</td>
                ...
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">IBAN: {{ $loja->empresa->iban1 }}</td>
                ...
                <tr>
                    <td style="text-transform: uppercase;color: #222222;font-weight: bolder">Observação: {{ $factura->observacao }}</td>
                    <td style="padding: 3px 0; text-align: center;border-top: 2px solid #000000">Software de facturação, desenvolvido pela {{ env('APP_NAME') }} </td>
                </tr>
