        ...
        @if ($loja->empresa->tipo_factura == "Normal")
            ...
            <main style="position: absolute;top: 230px;right: 30px;left: 30px;">
                ...
                <table class="table table-stripeds" style="border-top: 1px dashed #000;border-bottom: 1px dashed #000;">
                    ...
                    <tbody>
                        <tr>
                            <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">{{ ($movimento->movimento == "E") ? number_format( $movimento->debito, 2, ',', '.') : number_format($movimento->credito, 2, ',', '.') }}</td>
                            ...
                            <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">{{ ($movimento->forma_movimento == "NU") ? "NUMERÁRIO" : "MULTICAIXA" }}</td>
        ...
        @if ($loja->empresa->tipo_factura == "Ticket")
            ...
            <main style="position: absolute;top: 260px;right: 30px;left: 30px;width: 250px;">
                ...
                <table class="table table-stripeds" style="border-top: 1px dashed #000;border-bottom: 1px dashed #000;">
                    ...
                    <tbody>
                        <tr>
                            <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: left">{{ ($movimento->movimento == "E") ? number_format( $movimento->debito, 2, ',', '.') : number_format($movimento->credito, 2, ',', '.') }}</td>
                            <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">{{ $movimento->caixa->nome }}</td>
                        </tr>
                    </tbody>
                </table>
                ...
                <table style="border-top: 2px solid #000000">
                    <tbody>
                        ...
                        <tr>
                            <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: left">{{ ($movimento->forma_movimento == "NU") ? "NUMERÁRIO" : "MULTICAIXA" }}</td>
                            <td style="font-weight: bolder;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder;border-bottom: 1px solid #000;text-align: right">{{ $movimento->data_at }}</td>
                        </tr>
                    </tbody>
                </table>
