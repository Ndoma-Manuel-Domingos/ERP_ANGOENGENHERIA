    ...
    <body>
        ...
        <main style="position: absolute;top: 230px;right: 30px;left: 30px;">
            ...
            <table>
                <tr>
                    ...
                    <td style="text-align: right;text-transform: uppercase">Forma de pagamento: {{ $factura->pagamento == 'NU' ? 'NUMERÁRIO' : ($factura->pagamento == 'OU' ? 'DUPLO' :'MULTICAIXA' )  }}</td>
                </tr>
            </table>
            @php
            $numero = 0;
            ...
            <table class="table table-stripeds" style="border-top: 1px dashed #000;border-bottom: 1px dashed #000;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format( $item->retencao_fonte, 2, ',', '.') }}</td>
        ...
        <header style="position: absolute;top: 30;right: 30px;left: 30px;width: 250px;">
            <table>
                ...
                <tr>
                    <td style="text-transform: uppercase;font-weight: bolder">Endereço: {{ $loja->empresa->morada }}</td>
                    <td>DADOS CLIENTES</td>
                </tr>
                <tr>
                    <td style="text-transform: uppercase;font-weight: bolder"> NIF: {{ $loja->empresa->nif }}</td>
                    <td style="border-top: #eaeaea 1px solid;border-left: #eaeaea 1px solid; padding: 2px;">
                        <strong style="text-transform: uppercase;font-weight: bolder">{{ $factura->cliente->nome }}</strong>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="text-transform: uppercase;font-weight: bolder"> E-mail: {{ $loja->empresa->website }} </td>
                    
                </tr>
            </table>
        </header>

        <main style="position: absolute;top: 250px;right: 30px;left: 30px;width: 250px;">
            <table>
                <tr>
                    <td style="text-transform: uppercase;padding: 10px 0;font-size: 11px;font-weight: bolder">Luanda-Angola <br><br> FACTURA RECIBO</td>
                </tr>
                <tr>
                    @if ($factura->convertido_factura == "Y")
            ...
            <table>
                <tr>
                    ...
                    <td style="font-size: 10px;padding: 1px 0;text-transform: uppercase;color: #222222;font-weight: bolder">pagamento: {{ $factura->pagamento == 'NU' ? 'NUMERÁRIO' : ($factura->pagamento == 'OU' ? 'DUPLO' :'MULTICAIXA' )  }}</td>
                </tr>
            </table>
            ...
            <table style="border-top: 2px solid #000000">
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td style="text-align: left;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder"><strong>Total a Pagar:</strong> {{ number_format($factura->valor_total , '2', ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td style="text-align: left;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder"><strong>Valor Entregue:</strong> {{ number_format($factura->valor_entregue , '2', ',', '.') }}</td>
                    </tr>
                    <tr>
                        <td></td>
                        <td style="text-align: left;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder"><strong>Troco:</strong> {{ number_format($factura->valor_troco , '2', ',', '.') }}</td>
                    </tr>
    
                    <tr>
                        <td></td>
                        <td style="text-align: left;padding: 3px 0;text-transform: uppercase;color: #222222;font-weight: bolder"><strong>Total pago:</strong> {{ number_format($factura->valor_total , '2', ',', '.') }}</td>
                    </tr>
