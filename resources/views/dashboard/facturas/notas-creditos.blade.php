          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                ...
                <a href="{{ route('pdf-notas-creditos') }}" target="_blink" class="btn btn-sm btn-info float-right"><i class="fas fa-file-pdf"></i> Exportar PDF</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12 bg-light">
                  <form action="{{ route('notas-creditos') }}" method="get" class="mt-3">
                    @csrf
                  ...
                  @if ($facturas)
                    @foreach ($facturas as $item)
                      <tr>
                        ...
                        <td class="text-right"><a href="{{ route('factura-nota-credito', $item->code) }}" target="_blink"><i class="fas fa-print"></i> </a></td>
                      </tr>
                    @endforeach
                  @endif
                </tbody>
