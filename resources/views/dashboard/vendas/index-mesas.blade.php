...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Mesa: {{ $mesa ? $mesa->nome : '' }}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('pronto-venda-mesas') }}" class="btn btn-info">VOLTAR</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('mudar-status-mesa', $mesa->id) }}" class="btn btn-danger">DESOCUPAR A MESA</a></li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                        ...
                                        <div class="tab-content" id="custom-tabs-four-tabContent">
                                            <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
                                                ...
                                                <div class="row" id="carregar_produtos">
                                                    ...
                                                    <div class="col-6 col-md-3 col-lg-2">
                                                        {{-- <a href="{{ route('adicionar-produto', [$item->id, $mesa ? $mesa->id : '']) }}" class="adicionar-carrinho" style="cursor: pointer" data-id="{{ $item->id }}" data-nome="{{ $item->nome }}" data-preco="{{ $item->preco_venda }}"> --}}
                                                        <a class="adicionar-carrinho" style="cursor: pointer" data-mesa="{{ $mesa->id }}" data-id="{{ $item->id }}" data-nome="{{ $item->nome }}" data-preco="{{ $item->preco_venda }}">
                                            ...
                                            <div class="tab-pane fade" id="custom-tabs-four-profile{{ $categoria->id }}" role="tabpanel" aria-labelledby="custom-tabs-four-profile-tab{{ $categoria->id }}">
                                                <div class="row">
                                                    ...
                                                    <div class="col-6 col-md-3 col-lg-2">
                                                        {{-- <a href="{{ route('adicionar-produto', [$produto->id, $mesa ? $mesa->id : '']) }}"> --}}
                                                        <a class="adicionar-carrinho" style="cursor: pointer" data-mesa="{{ $mesa->id }}" data-id="{{ $item->id }}" data-nome="{{ $item->nome }}" data-preco="{{ $item->preco_venda }}">
                                                            <div class="card shadow-sm bg-light">
                                                                @if ($produto->estoque)
                                                                    ...
                                                                    <div class="card-body bg-info">
                                                                        @endif
                                                                            ...
                                                                            <div class="card-body bg-warning">
                                                                                @endif
                                                                                <div class="col-12 col-md-12 col-sm-12">
                                                                                    <h6 class="pt-3 text-uppercase text-white">{{ $produto->nome }}</h6>
                                                                                    <p class="text-white">
                                                                                        <strong>{{ number_format($produto->preco_venda, 2, ',', '.') }} <small>{{ $loja->moeda }}</small></strong>
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                                            <!-- /.card-body -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
                    ...
                    success: function(response) {
                        ...
                        for (let index = 0; index < response.produtos.length; index++) {
                            ...
                            $('#carregar_produtos').append('<div class="col-6 col-md-3 col-lg-2">\
                                <a id="adicionar-carrinho-exemplo" style="cursor: pointer;" data-mesa="' + mesa + '" data-id="' + response.produtos[index].id + '" data-nome="' + response.produtos[index].nome + '" data-preco="' + response.produtos[index].preco_venda + '">\
                                    <div class="card shadow-sm bg-light">\
        ...
        document.querySelectorAll('.produto_codigo_barra').forEach(button => {
            button.addEventListener('input', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $('#carregar_produtos').append('<div class="col-6 col-md-3 col-lg-2">\
                            <a href="../adicionar-produto/' + response.produtos.id + '/' + mesa + '">\
                                <div class="card shadow-sm bg-light">\
                                    <div class="card-body ' + btn + '" ">\
                                        <div class="col-12 col-md-12 col-sm-12">\
    ...
    document.querySelector('#finalizar-venda').addEventListener('click', function() {
        ...
        let pagamentoData = {
            ...
            mesa_id: document.getElementById('mesa_id').value, // Exemplo de valor recebido
