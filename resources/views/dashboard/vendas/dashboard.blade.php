                            ...
                            <table class="table table-hover text-nowrap" id="carregar_tabela"  style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">{{ number_format($item->valor_entregue, 2, ',', '.') }} <span class="text-secondary">{{ $empresa->moeda }}</span></td>
                                        <td class="text-right">{{ number_format($item->valor_troco, 2, ',', '.') }} <span class="text-secondary">{{ $empresa->moeda }}</span></td>
                                        <td class="text-right">{{ number_format($item->desconto, 2, ',', '.') }} <span class="text-secondary">{{ $empresa->moeda }}</span></td>
                                        <td class="text-right">{{ number_format($item->valor_total, 2, ',', '.') }} <span class="text-secondary">{{ $empresa->moeda }}</span></td>
                                        <td class="text-right">
