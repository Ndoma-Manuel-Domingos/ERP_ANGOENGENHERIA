                    ...
                    <form action="{{ route('finalizar-venda-create') }}" method="post" id="quickForm">
                        ...
                        <div class="card">
                            <div class="card-body" style="height: 580px;">
                                <div action="" class="row">
                                    ...
                                    <input type="hidden" name="venda_realizado" value="CAIXA">
                        ...
                        <div class="row text-center">
                            <div class="col-12 col-md-4">
                                <div class="card">
                                    <button type="submit" class="btn btn-dark col-12 col-md-12 p-4 text-center float-right">
                            ...
                            <div class="col-12 col-md-6 card pt-3">
                                <div class="row">
                    ...
                    <div class="card bg-dark">
                        ...
                        <div class="bg-info">
                            ...
                            <a href="{{ route('pronto-venda') }}" class="btn btn-info btn-flat col-12 col-md-12 p-4 text-center float-right">
                                <span class="h3 text-white text-uppercase"><i class="fas fa-close"></i> Cancelar </span>
                            </a>
                            {{-- </div> --}}
                        </div>
                    </div>
