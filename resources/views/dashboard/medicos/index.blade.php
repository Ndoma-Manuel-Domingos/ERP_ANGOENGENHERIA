                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                <a href="{{ route('medicos.create') }}" class="btn btn-sm btn-primary">Novo Médico</a>
                            </h3>
                        ...
                        <div class="card-body table-responsive">
                            <table class="table table-hover text-nowrap" id="carregar_tabela"  style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><a href="{{ route('medicos.show', $item->id) }}">{{ $item->nome }} </a></td>
                                        <td>{{ $item->genero ?? '------' }}</td>
                                        ...
                                        <td class="text-right">
                                          <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item" href="{{ route('medicos.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                                                <a class="dropdown-item" href="{{ route('medicos.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
                                                <div class="dropdown-divider"></div>
                                                <form action="{{ route('medicos.destroy', $item->id ) }}" method="post">
                                                    @csrf
                                                    @method('DELETE')
