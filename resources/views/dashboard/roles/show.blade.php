...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Detalhe Perfil</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-footer clearfix d-flex">
              <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-sm btn-success mx-1">
              ...
              <form action="{{ route('roles.destroy', $role->id ) }}" method="post">
                ...
                <button type="submit" class="btn btn-sm btn-danger mx-1"
                  onclick="return confirm('Tens Certeza que Desejas excluir esta Perfil?')">
