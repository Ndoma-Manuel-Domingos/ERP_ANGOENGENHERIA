            ...
            <div class="row">
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-7 offset-md-3 my-5">
                                ...
                                <div class="form-group row mb-3">
                                    ...
                                    <select name="tipo_documento" id="tipo_documento" class="form-control col-12 col-md-10">
                                ...
                                <div class="form-group row mb-3">
                                    <label for="data_inicio" class="form-label col-12 col-md-2">Data Inicio</label>
                                    <input type="date" id"data_inicio" name="data_inicio" class="form-control col-12 col-md-10">
                                </div>

                                <div class="form-group row mb-3">
                                    <label for="data_final" class="form-label col-12 col-md-2">Data Final</label>
                                    <input type="date" name="data_final" id="data_final" class="form-control col-12 col-md-10">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer text-center">
                        <button type="submit" class="btn-lg btn-primary">Refazer</button>
                    </div>
                </div>
            </div>
        </form>
