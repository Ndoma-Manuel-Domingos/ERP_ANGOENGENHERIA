...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Criar Marcações de Faltas</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('marcacoes-faltas.index') }}">Voltar</a></li>
                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                              ...
                              <div class="row">
                                ...
                                <div class="col-12 col-md-4">
                                  ...
                                  <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('duracao') is-invalid @enderror" id="duracao" name="duracao"  placeholder="Informe a Duração">
                                  </div>
                                </div>
                        ...
                        <div class="card-footer">
                            ...
                            <button id="saveDates" class="btn btn-primary" style="margin-top: 10px; display: none;">Salvar Faltas</button>
                            {{-- @endif --}}
                        </div>
                    </div>
                </div>
