                        ...
                        <form action="{{ route('clientes.update', $cliente->id) }}" method="post" class="">
                            ...
                            <div class="card-body row">
                                 ...
                                 <div class="col-12 col-md-3">
                                    <label for="tipo_cliente" class="form-label">Tipo Cliente <span class="text-secondary">(Opcional)</span>:</label>
                                        <select type="text" class="form-control select2" name="tipo_cliente">
                                            ...
                                            <option value="C" {{ $cliente->tipo_cliente == "C" ? 'selected' : '' }}>Correntes</option>
                                            <option value="TR" {{ $cliente->tipo_cliente == "TR" ? 'selected' : '' }}>Títulos a Receber</option>
                                            <option value="TD" {{ $cliente->tipo_cliente == "TD" ? 'selected' : '' }}>Títulos Descontados</option>
                                            <option value="CD" {{ $cliente->tipo_cliente == "CD" ? 'selected' : '' }}>Cobrança Duvidosa</option>
                                            <option value="SC" {{ $cliente->tipo_cliente == "SC" ? 'selected' : '' }}>Saldos Credores</option>
                                        </select>
                                    <p class="text-danger">
                                        @error('tipo_cliente')
                                        {{ $message }}
                              ...
                              <div class="col-12 col-md-3">
                                  ...
                                  <input type="date" class="form-control" name="data_nascimento" value="{{ $cliente->data_nascimento ?? old('data_nascimento') }}" placeholder="Data Nascimento">
                                  <p class="text-danger">
                              ...
                              <div class="col-12 col-md-3">
                                  ...
                                  <select type="text" class="form-control select2" name="genero">
                                      ...
                                      <option value="Personalizado" {{ $cliente->genero == "Personalizado" ? 'selected' : '' }}>Personalizado</option>
                                  </select>
                                  <p class="text-danger">
                                      @error('genero')
                                      {{ $message }}
                              ...
                              <div class="col-12 col-md-3">
                                  ...
                                  <select type="text" class="form-control select2" name="estado_civil_id">
                                      ...
                                      <option value="{{ $item->id }}" {{ $cliente->estado_civil_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                      @endforeach
                                  </select>
                                  <p class="text-danger">
                              ...
                              <div class="col-12 col-md-3">
                                ...
                                <select type="text" class="form-control select2" name="seguradora_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ $cliente->seguradora_id  == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                    @endforeach
                                </select>
                                <p class="text-danger">
                                    @error('seguradora_id')
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <select type="text" class="form-control select2" name="provincia_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ $cliente->provincia_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                    @endforeach
                                </select>
                                <p class="text-danger">
                                    @error('provincia_id')
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <select type="text" class="form-control select2" name="municipio_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ $cliente->municipio_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                    @endforeach
                                </select>
                                <p class="text-danger">
                                    @error('municipio_id')
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <select type="text" class="form-control select2" name="distrito_id">
                                    ...
                                    <option value="{{ $item->id }}" {{ $cliente->distrito_id == $item->id ? 'selected' : '' }}>{{ $item->nome }}</option>
                                    @endforeach
                                </select>
                                <p class="text-danger">
                                    @error('distrito_id')
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="text" class="form-control" name="telefone" value="{{ $cliente->telefone ?? old('telefone') }}" placeholder="Informe Telefone">
                                <p class="text-danger">
                                    @error('telefone')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="text" class="form-control" name="telemovel" value="{{ $cliente->telemovel ?? old('telemovel') }}" placeholder="Informe  Telemóvel">
                                <p class="text-danger">
                                    @error('telemovel')
                                    {{ $message }}
                                    @enderror
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="email" class="form-control" name="email" value="{{ $cliente->email ?? old('email') }}" placeholder="Informe  E-email">
                                <p class="text-danger">
                                    @error('email')
                                    {{ $message }}
                                    @enderror
