                            ...
                            <div class="card">
                                <div class="card-body row">
                                    <div class="col-12 col-md-2">
                                        ...
                                        <select type="text" class="form-control select2" id="processamento_id"
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <select type="text" class="form-control select2" id="exercicio_id"
                                            name="exercicio_id">
                                            <option value="">Selecione</option>
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <select type="text" class="form-control select2" id="periodo_id"
                                            name="periodo_id">
                                            <option value="">Selecione</option>
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" class="form-control" value="" id="data_inicio"
                                                name="data_inicio" placeholder="Data Inicio">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="date" class="form-control" value="" id="data_final"
                                                name="data_final" placeholder="Data final">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="number" class="form-control" value="22"
                                                name="dias_processados" id="dias_processados"
                                                placeholder="Dias processados">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            @foreach ($processamentos as $item)
                                                <tr>
                                                    <td>{{ $item->id }}</td>
                                                    <td><a
                                                            href="{{ route('funcionarios.show', $item->funcionario->id) }}">{{ $item->funcionario->numero_mecanografico }}</a>
                                                    </td>
                                                    ...
                                                    <td><a href="{{ route('recibo-processamentos', $item->id) }}"
                                                            class="text-center" target="_blink"><i
