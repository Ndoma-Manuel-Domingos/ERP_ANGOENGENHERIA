                                ...
                                <div class="card-body row">
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="time" class="form-control" value="{{ $requests['hora_entrada'] ?? '' }}" name="hora_entrada" placeholder="Hora Inicio">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-md-2">
                                        ...
                                        <div class="input-group mb-3">
                                            <input type="time" class="form-control" value="{{ $requests['hora_saida'] ?? '' }}" name="hora_saida" placeholder="Hora final">
                                        </div>
                                    </div>
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a class="btn btn-sm btn-danger" target="_blink" href="{{ route('pdf-reservas', 
                                        [
                                                            ...
                                                            <div class="dropdown-menu" role="menu">
                                                                ...
                                                                @if (Auth::user()->can('eliminar reserva'))
                                                                    <form
                                                                        ...
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit" class="btn btn-sm btn-danger dropdown-item"
