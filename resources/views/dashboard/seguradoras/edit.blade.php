...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Editar Seguradora</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card-body row">
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="nome" value="{{ $seguradora->nome }}"
            ...
            <div class="col-12">
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" name="numero" value="{{ $seguradora->numero }}"
                  placeholder="Informe a Seguradora">
              </div>
              <p class="text-danger">
                @error('numero')
