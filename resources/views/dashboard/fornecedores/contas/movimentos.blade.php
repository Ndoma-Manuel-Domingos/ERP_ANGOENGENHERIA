                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    @if ($movimento->tipo_movimento > 0)
                        <td class="text-right text-success">{{ number_format($movimento->montante, 2, ',', '.') }} {{ $empresa->empresa->moeda }}</td>
                    @endif

                    @if ($movimento->tipo_movimento < 0)
                        <td class="text-right text-danger">{{ number_format($movimento->montante, 2, ',', '.') }} {{ $empresa->empresa->moeda }}</td>
                    @endif
