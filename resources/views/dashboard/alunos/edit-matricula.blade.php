...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Editar Matrícula</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{ route('alunos-matriculas') }}">Voltar</a></li>
  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-12 col-md-12">
          <div class="card">
            <form action="{{ route('alunos.update', $matricula->aluno->id) }}" method="post" class="">
              @csrf
              @method('put')
              ...
              <div class="card-body row">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="nome" value="{{ $matricula->aluno->nome ?? old('nome') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="nif" value="{{ $matricula->aluno->nif ?? old('nif') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <select type="text" class="form-control select2" name="genero">
                      ...
                      <option value="Masculino" {{ $matricula->aluno->genero == "Masculino" ? 'selected': "" }}>Masculino</option>
                      <option value="Femenino" {{ $matricula->aluno->genero == "Femenino" ? 'selected': "" }}>Femenino</option>
                    </select>
                  </div>
                  <p class="text-danger">
                    @error('genero')
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <select type="text" class="form-control select2" name="estado_civil">
                      <option value="">Selecionar</option>
                      <option value="CASADO(A)" {{ $matricula->aluno->estado_civil == "CASADO(A)" ? 'selected': "" }}>CASADO(A)</option>
                      <option value="SOLTEIRO(A)" {{ $matricula->aluno->estado_civil == "SOLTEIRO(A)" ? 'selected': "" }}>SOLTEIRO(A)</option>
                      <option value="DIVORCIADO" {{ $matricula->aluno->estado_civil == "DIVORCIADO" ? 'selected': "" }}>DIVORCIADO</option>
                    </select>
                  </div>
                  <p class="text-danger">
                    @error('estado_civil')
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="date" class="form-control" name="data_nascimento" value="{{ $matricula->aluno->data_nascimento ?? old('data_nascimento') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="pai" value="{{ $matricula->aluno->pai ?? old('pai') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="mae" value="{{ $matricula->aluno->mae ?? old('mae') }}"
                ...
                <div class="col-12 col-md-6">
                  <label for="" class="form-label">Gestor da conta</label>
                  <div class="input-group mb-3">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                    </div>
                    <select type="text" class="form-control" name="gestor_conta">
                      <option value="">Gestor de Conta</option>
                      <option value="{{ Auth::user()->id }}" {{ Auth::user()->id = $matricula->aluno->gestor_conta ? 'selected': "" }}>{{ Auth::user()->name }}</option>
                    </select>
                  </div>
                  <p class="text-danger">
                    @error('gestor_conta')
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="codigo_postal" value="{{ $matricula->aluno->codigo_postal ?? old('codigo_postal') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="localidade" value="{{ $matricula->aluno->localidade ?? old('localidade') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="telefone" value="{{ $matricula->aluno->telefone ?? old('telefone') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="telemovel" value="{{ $matricula->aluno->telemovel ?? old('telemovel') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="email" class="form-control" name="email" value="{{ $matricula->aluno->email ?? old('email') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="website" value="{{ $matricula->aluno->website ?? old('website') }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="observacao" value="{{ $matricula->aluno->observacao ?? old('observacao') }}"
