              ...
              <div class="card-body row">
                ...
                <div class="col-12 col-md-6">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="codigo_postal" value="{{ $aluno->codigo_postal ?? '00000' }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="localidade" value="{{ $aluno->localidade ?? 'Luanda' }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="telefone" value="{{ $aluno->telefone ?? '900 000 000' }}"
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="telemovel" value="{{ $aluno->telemovel ?? '244 220 000 000' }}"
