...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Cadastrar Subconta</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          ...
          <div class="card">
            <form action="{{ route('subcontas.store') }}" method="post" class="">
              ...
              <div class="card-body row">
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <select type="text" class="select2 form-control @error('conta_id') is-invalid @enderror" id="conta_id" name="conta_id">
                      ...
                      <option value="{{ $item->id }}" {{ $requests['subconta_id'] == $item->id ? 'selected' : "" }}>{{ $item->conta }} - {{ $item->nome }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
                ...
                <div class="col-12 col-md-3">
                  ...
                  <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control  @error('numero') is-invalid @enderror" name="numero" id="numero" value="{{ old('numero') }}" placeholder="Informe o número da sequência">
                  </div>
                </div>
              ...
              <div class="card-footer">
                @if (Auth::user()->can('criar subconta'))
