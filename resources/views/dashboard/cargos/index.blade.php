          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">
                ...
                <a href="{{ route('cargos.create') }}" class="btn btn-sm btn-primary">Novo Cargo</a>
                @endif
              </h3>
                    ...
                    <td class="text-right">
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu" role="menu">
                          ...
                          <a class="dropdown-item" href="{{ route('cargos.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                          @endif
                          @if (Auth::user()->can('editar cargo'))
                          <a class="dropdown-item" href="{{ route('cargos.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
                          @endif
                          ...
                          <form action="{{ route('cargos.destroy', $item->id ) }}" method="post">
                              @csrf
                              @method('DELETE')
                              <button type="submit" class="btn btn-sm btn-danger dropdown-item" onclick="return confirm('Tens Certeza que Desejas excluir esta cargo?')">
