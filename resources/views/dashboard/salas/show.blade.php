        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-footer clearfix d-flex">
              <a href="{{ route('salas.edit', $sala->id) }}" class="btn btn-sm btn-success mx-1">
              ...
              <form action="{{ route('salas.destroy', $sala->id ) }}" method="post">
                ...
                <button type="submit" class="btn btn-sm btn-danger mx-1"
                  onclick="return confirm('Tens Certeza que Desejas excluir esta Sala?')">
