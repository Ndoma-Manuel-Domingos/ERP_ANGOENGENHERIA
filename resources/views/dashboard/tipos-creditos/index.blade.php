    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tipos de Créditos</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                            ...
                            <div class="card-header">
                                <h3 class="card-title">
                                    @if (Auth::user()->can('criar conta'))
                                        <a href="{{ route('tipos-creditos.create') }}" class="btn btn-sm btn-primary">Novo Tipo de Crédito</a>
                                    @endif
                                </h3>
                                                        ...
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" role="menu">
                                                                @if (Auth::user()->can('listar conta'))
                                                                    <a class="dropdown-item" href="{{ route('tipos-creditos.show', $item->id) }}"><i class="fas fa-eye text-info"></i> Detalhes</a>
                                                                @endif
                                                                @if (Auth::user()->can('editar conta'))
                                                                    <a class="dropdown-item" href="{{ route('tipos-creditos.edit', $item->id) }}"><i class="fas fa-edit text-success"></i> Editar</a>
                                                                @endif
                                                                <div class="dropdown-divider"></div>
                                                                @if (Auth::user()->can('eliminar conta'))
                                                                    <form
                                                                        action="{{ route('tipos-creditos.destroy', $item->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('DELETE')
                                                                        <button type="submit"
                                                                            class="btn btn-sm btn-danger dropdown-item"
                                                                            onclick="return confirm('Tens Certeza que Desejas excluir esta Tipo de Crédito?')">
