                                ...
                                <div class="card-body">
                                    <div class="bs-stepper">
                                        ...
                                        <div class="bs-stepper-header" role="tablist">
                                            ...
                                            <div class="step" data-target="#paconte-salarial">
                                                <button type="button" class="step-trigger" role="tab"
                                                    aria-controls="paconte-salarial" id="paconte-salarial-trigger">
                                        ...
                                        <div class="bs-stepper-content">
                                            ...
                                            <div id="paconte-salarial" class="content" role="tabpanel"
                                                aria-labelledby="paconte-salarial-trigger">
                                                        ...
                                                        <div class="field-group-desconto">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-md-2">
                                                                    ...
                                                                    <div class="input-group mb-3">
                                                                        <select
                                                                            class="form-control  @error('tipo_valor_1') is-invalid @enderror"
                                                                            id="tipo_valor_1" name="tipo_valor[]">
