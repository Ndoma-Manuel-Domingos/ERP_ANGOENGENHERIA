          ...
          <div class="card-body row">
            ...
            <div class="col-12 col-md-12">
              ...
              <div class="input-group mb-3">
                ...
                <select type="text" class="form-control select2" name="consulta_id">
                  <option value="activo">Selecionar a Consulta</option>
                  @foreach ($produtos as $item)
                  <option value="{{ $item->id }}" {{ $item->id == old('consulta_id') ? 'selected' : ''  }}>{{ $item->nome }}</option>
                  @endforeach
                </select>
              </div>
              <p class="text-danger">
            ...
            <div class="col-12 col-md-12">
              ...
              <div class="input-group mb-3">
                ...
                <select type="text" class="form-control select2" name="paciente_id">
                  <option value="activo">Selecionar a Pacientes</option>
                  @foreach ($pacientes as $item)
                  <option value="{{ $item->id }}" {{ $item->id == old('paciente_id') ? 'selected' : ''  }}>{{ $item->nome }}</option>
                  @endforeach
                </select>
              </div>
              <p class="text-danger">
            ...
            <div class="col-12 col-md-12">
              ...
              <div class="input-group mb-3">
                ...
                <select type="text" class="form-control select2" name="medico_id">
                  <option value="activo">Selecionar a Médico</option>
                  @foreach ($medicos as $item)
                  <option value="{{ $item->id }}" {{ $item->id == old('medico_id') ? 'selected' : ''  }}>{{ $item->nome }}</option>
                  @endforeach
                </select>
              </div>
              <p class="text-danger">
            ...
            <div class="col-12 col-md-12">
              ...
              <div class="input-group mb-3">
                ...
                <input type="date" class="form-control" name="data_consulta" value="{{ old('data_consulta') }}"
            ...
            <div class="col-12 col-md-12">
              ...
              <div class="input-group mb-3">
                ...
                <input type="time" class="form-control" name="hora_consulta" value="{{ old('hora_consulta') }}"
            ...
            <div class="col-12 col-md-12">
              ...
              <div class="input-group mb-3">
                <textarea name="observacao" class="form-control" id="" cols="30" rows="6" placeholder="Descrever um Observação opcional"></textarea>
              </div>
              <p class="text-danger">
                @error('observacao')
                {{ $message }}
