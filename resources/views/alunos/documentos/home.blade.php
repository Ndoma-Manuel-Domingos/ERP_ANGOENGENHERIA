                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu" role="menu">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('activar-solicitacoes-documentos', $item->id) }}"><i class="fas fa-check text-info"></i> Em processo</a>
                                                    @endif
                                                    
                                                    @if ($item->status == "em processo")
                                                    <a class="dropdown-item" href="{{ route('desactivar-solicitacoes-documentos', $item->id) }}"><i class="fas fa-times text-info"></i> Entregar</a>
                                                    @endif
