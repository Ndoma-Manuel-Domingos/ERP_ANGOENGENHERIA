...
class CategoriaCargoController extends Controller
{
    ...
    public function index()
    {
        ...
        $categorias = CategoriaCargo::where([
            ['entidade_id', '=', $entidade->empresa->id], 
        ])->orderBy('created_at', 'desc')->get();

        $head = [
            "titulo" => "Categoria de Cargos",
    ...
    public function create()
    {
        ...
        $head = [
            "titulo" => "Cadastrar Categoria de Cargos",
            "descricao" => env('APP_NAME'),
            "tipo_entidade_logado" => User::with(['empresa.tipo_entidade.modulos'])->findOrFail(Auth::user()->id),
        ];

        return view('dashboard.categorias-cargos.create', $head);
    }
    ...
    public function show($id)
    {
        ...
        $head = [
            "titulo" => "Detalhe Categoria de Cargos",
            "descricao" => env('APP_NAME'),
            "categoria" => $categoria,
            "tipo_entidade_logado" => User::with(['empresa.tipo_entidade.modulos'])->findOrFail(Auth::user()->id),
        ];
    ...
    public function edit($id)
    {
        ...
        $head = [
            "titulo" => "Editar Categoria de Cargos",
            "descricao" => env('APP_NAME'),
            "categoria" => $categoria,
            "tipo_entidade_logado" => User::with(['empresa.tipo_entidade.modulos'])->findOrFail(Auth::user()->id),
        ];

        return view('dashboard.categorias-cargos.edit', $head);
    }
